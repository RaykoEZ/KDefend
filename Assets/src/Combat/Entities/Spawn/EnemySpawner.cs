...
public class EnemySpawner : EntitySpawner<Enemy>
{
    ...
    public override void Spawn(
        ...
        Transform parent,
        int numToSpawn = 1, 
        float spawnDelayInterval = 3f, 
        Action<Enemy> onSpawnAction = null) 
    {
        StartCoroutine(Spawn_Internal(spawnRef, parent, numToSpawn, spawnDelayInterval, onSpawnAction));
    }
    IEnumerator Spawn_Internal(Enemy spawnRef, Transform parent, int numToSpawn = 1, float spawnDelayInterval = 3f, Action<Enemy> onSpawnAction = null) 
    {
        int numSpawned = 0;
