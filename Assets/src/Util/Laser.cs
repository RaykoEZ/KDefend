...
public class Laser : DirectionArrow 
{
    ...
    public RaycastHit2D PointTowardsDirection(Vector3 origin, Vector3 dirNormalize)
    {
        RaycastHit2D visual;
        visual = RenderLine(m_lineRender, origin, dirNormalize, m_lengthScale, m_blockingLayers);
        return visual;
    }
    public void Clear()
    {
